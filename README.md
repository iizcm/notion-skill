...
cp -r productivity/notion ~/.hermes/skills/productivity/notion/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/notion-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/notion-skill.git ~/.hermes/skills/productivity/notion/
```
...
```text
skill_view(name="productivity/notion")
```
...
```text
Use the notion skill to <describe your specific task here>
```
...
```text
Gunakan skill notion untuk <deskripsikan tugas spesifik Anda di sini>
```
